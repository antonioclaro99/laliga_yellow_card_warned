...
const AbilitiesText = {
  ...
  overgrow: {
    name: "Overgrow Prueba 2",
    desc: "AAA When this Pokemon has 1/3 or less of its maximum HP, rounded down, its offensive stat is multiplied by 1.5 while using a Grass-type attack.",
    shortDesc: "BBBB At 1/3 or less of its max HP, this Pokemon's offensive stat is 1.5x with Grass attacks.",
    gen4: {
      desc: "CCCC When this Pokemon has 1/3 or less of its maximum HP, rounded down, its Grass-type attacks have their power multiplied by 1.5.",
      shortDesc: "DDDD At 1/3 or less of its max HP, this Pokemon's Grass-type attacks have 1.5x power."
    }
  },
  owntempo: {
    name: "Own Tempo",
